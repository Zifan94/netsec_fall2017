		...
		for packet in self._deserializer.nextPackets():
			...
			if isinstance(packet, RequestPacket):
				...
				if self.state != "wait_for_verify_packet":
					...
					self.transport.write(packetBytes)
					if __name__ =="__main__":
						print("Server Side: The Verification Result is:")
...
if __name__ =="__main__":
	...
	coro = playground.getConnector('passthrough').create_playground_server(lambda: VerificationCodeServerProtocol(loop), 101)
